...
export default class AppComponent {
  ...
  handleUnloadEvent(): void {
    ...
    window.localStorage.setItem('isTextbookPage', this.store.selectSnapshot(RSLState.isTextbookPage));
  ...
  constructor(private store: Store) {
    ...
    const isTextbookPage: string = window.localStorage.getItem('isTextbookPage') ?? 'true';
    ...
    this.store.dispatch(new SetIfIsTextbookPage(isTextbookPage));
